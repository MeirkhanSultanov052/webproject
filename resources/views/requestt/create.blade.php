...
<head>
    ...
    <title>@lang('lang.leave_a_request')</title>
...
<body onload="load()">
    ...
    <div id="main">
    <h1>@lang('lang.leave_a_request')</h1>
        <div class="container">
            <form id = "form" method="POST" action="{{ route('add-request')}}" enctype="multipart/form-data">
            @csrf 
            <input type="number" name="consumer_id" placeholder="@lang('lang.consumer_id')">
            <input type="text" name="title" placeholder="@lang('lang.title')">
            <input type="text" name="body" placeholder="@lang('lang.body')">
